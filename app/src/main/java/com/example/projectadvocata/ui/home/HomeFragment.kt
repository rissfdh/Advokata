...
class HomeFragment : Fragment() {
    ...
    private fun getListNews(): List<News> {
        ...
        newsList.add(
            News("Agus Buntung Penyandang Disabilitas Viral", "     Kasus pelecehan seksual yang melibatkan I Wayan Agus Suartama, atau yang dikenal sebagai Agus Buntung, hingga kini terus menjadi sorotan publik,Terbaru, penyandang disabilitas asal NTB ini resmi ditetapkan sebagai tersangka oleh Polda NTB setelah menerima laporan dari sejumlah korban.\n" +
                "\n" + "    Meskipun Agus sempat membantah tuduhan tersebut dan mengklaim dirinya difitnah, fakta dan kesaksian dari berbagai pihak, termasuk penjaga homestay, mengungkap sisi lain dari kasus ini.", R.drawable.news1)
        )
        newsList.add(
            News(" Viral Video Gus Miftah Emosi dengan Penjual Es Teh", "Kumpulan video lawas Gus Miftah bercanda dan memaki menggunakan kata-kata kasar mendadak jadi sorotan, setelah kasusnya menghina penjual es teh goblok. \n" +
                "\n", R.drawable.news2)
        )
        newsList.add(News("Agus \"Sedih Banget\" Sampai Sesegukan Dibully Netizen\n", "Kisruh soal uang donasi antara Agus Salim, Noviyanthi Pratiwi dan Denny Sumargo masih terus berlanjut makain panas. Diketahui, Teh Novi dan Denny Sumargo merupakan orang yang pertama kali membuka donasi untuk Agus. Namun kasus ini semakin rumit lantaran Agus disebut tidak memanfaatkan duit itu untuk keperluan pengobatan. Apalagi kini Agus dibantu oleh pengacara Farhat Abas dan Alvin Lim yang dianggap semakin memperkeruh keadaan.\n", R.drawable.news3))
